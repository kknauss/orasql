column elap_time_sec format 999999999999;
...
and extract(hour from s.BEGIN_INTERVAL_TIME) between 12 and 17
and extract(hour from s.END_INTERVAL_TIME)   between 12 and 17
group by
